...
namespace Banca
{
    ...
    {
        protected double saldo { get; } = 0; // saldo del conto corrente
        protected int nMovimenti { get; } = 0; // numero di movimenti sul conto corrente
        protected int maxMovimenti { get; } = 50; // max movimenti sul conto corrente
